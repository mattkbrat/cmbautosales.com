	...
	return (
		<main className="flex min-h-screen lg:flex-row flex-col relative bg-surface-50 overflow-x-clip">
			...
			<div className="flex flex-col w-full text-white min-h-screen sm:min-h-max">
				...
				<section
					id="contact"
					className="bg-secondary-800/85 min-h-24 py-2 sm:py-10 space-y-4  w-full flex flex-row flex-wrap px-4 lg:px-10 gap-x-4 align-start justify-around text-xs sm:text-sm lg:text-base"
				>
